define({ "api": [
  ...
  {
    "type": "get",
    "url": "/students/:id/chatDays/detail?date=XXX",
    "title": "某天的发言",
    "version": "1.0.0",
    "name": "GetStudentChatDayDetail",
    "group": "Student",
    "description": "<p>获取指定id学生的某天的发言，date格式为2016-10-22（必须指定）</p>",
    "success": {
      "examples": [
        {
          "title": "成功",
  ...
  {
    "type": "get",
    "url": "/students/:id/signInDays?date=XXX",
    "title": "有完成签到的日期",
    "version": "1.0.0",
  ...
  },
  {
    ...
    "name": "PutStudent",
    "group": "Student",
    "description": "<p>根据指定字段名和值修改指定id的学生，禁止修改id和手机号</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    ...
    "name": "PutTeacher",
    "group": "Teacher",
    "description": "<p>根据指定字段名和值修改指定id的教师，禁止修改id和手机号</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
