...
public class PhotoUtil {
	...
	public static Bitmap compress(Bitmap bitmap){
		...
		Log.e("s-length", bOut.toByteArray().length / 1024 + "");
		Log.e("s-size", bOut.size() / 1024 / 1024 + "");
		while(bOut.toByteArray().length / 1024>30){  //如果压缩后大于30Kb，则提高压缩率，重新压缩
			beginRate -=10;
			Log.e("length", bOut.toByteArray().length / 1024 + "");
			Log.e("size", bOut.size() / 1024 / 1024 + "");
			Log.e("rate", beginRate + "");
			bOut.reset();
		...
		if(newBitmap != null){
			Log.e("new", newBitmap.getByteCount() + "");
			return newBitmap;
		}else{
			return bitmap;
		}
