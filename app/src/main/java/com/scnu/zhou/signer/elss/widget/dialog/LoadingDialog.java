package com.scnu.zhou.signer.elss.widget.dialog;
...
public class LoadingDialog extends Dialog {
	...
	/*
	 * public LoadingDialog(Context context, boolean isTrans) { super(context,
	 * isTrans ? R.style.Loading_Dialog_trans : R.style.Dialog_bocop); init(); }
	 */
